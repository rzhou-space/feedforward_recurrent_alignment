...
%		\end{figure}
	...
	% Results.
		...
		With $n = 200$, comparing ranks $G = 1$ in blue dots with $G=10$ in orange:\\
		...
		\textbf{(c)} Dimensionality (y-axis) calculated analytically (lines, blue line for $G=1$ and orange line for $G=10$) and empirically in correlation with feedforward recurrent alignment (x-axis).\\
