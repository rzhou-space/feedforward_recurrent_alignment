...
%				\centering
%				\includegraphics{../figures/ttc_low_rank_sym_with_noise.png}
%			\end{subfigure}
%			\hfill
%			\begin{subfigure}{0.02\textwidth}
%				\centering
%				\includegraphics{../figures/its_low_rank_sym_with_noise.png}
%			\end{subfigure}
%		
%			\bigskip
%			\begin{subfigure}{0.02\textwidth}
%				\centering
%				\includegraphics{../figures/dim_low_rank_sym_with_noise.png}
%			\end{subfigure}
%			\hfill
%			\begin{subfigure}{0.02\textwidth}
%				\centering
%				\includegraphics{../figures/spont_align_low_rank_sym_with_noise.png}
%			\end{subfigure}
%		\end{figure}
		\begin{figure}[H]
			\centering
