...
\begin{document}
	...
	\subsubsection{Current State of the Feedforward Recurrent Hypothesis}
	% Four activity properties for evaluation.
	\subsubsection{Motivation for the Exploration}
	\subsubsection{Evolved Extensions}
	%TODO: List of notations, list of figures perhaps also?
\end{document}