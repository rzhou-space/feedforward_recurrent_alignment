...
##############################################################################################################
    ...
    #compare_dim_low_rank(n_neuron, R, kappa, beta_dim, num_sample, "real part")

    #compare_align_spont_low_rank(n_neuron, R, kappa, beta_spont, beta_dim, num_sample, "white noise")
